...
```
<project-root>/
├── .context.toml                # aictl project context file
└── .ai-deployed/
...
|------|----------------|---------------|---------|
| **claude-code** | `~/.claude/projects/{project}/` | Path separators (`/`, `\`) → dashes | `/Users/alice/Projects/myapp` → `-Users-alice-Projects-myapp` |
