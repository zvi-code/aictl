Here is my comprehensive research on the Microsoft Copilot ecosystem — covering hidden files, special structures, memory, configurations, instructions, agents, agent-teams, telemetry, and more — for the `aictl` tool.
