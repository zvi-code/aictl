...
> Companion to `ai-tools-config-paths.md`, `ai-tools-runtime-processes.md`, and
> `ai-tools-traffic-monitoring.md`. Compiled March 2026.
...
| Outbound | `api.anthropic.com` (or Bedrock/Vertex endpoints) |
...
| Risk | Severity | Detail |
|------|----------|--------|
| Subagent accumulation | **High** | `claude --print` processes may not terminate after Task tool; ~45 MB each, can reach 10+ GB |
